...
def Interior_Points(sep_teste, verbose=True, travado=False):
...
########################################################################### Vetores de condutância e susceptância série
    ...
    if len(sep_modelo.bus) == 118:
        ...
        shunt[4]= sep.Var(qshunt[4]*100,0*100,0.40*100, integer=True)
        shunt[33]= sep.Var(qshunt[33]*100,-0.2*100,0*100, integer=True)
        shunt[36]= sep.Var(qshunt[36]*100,0*100,0.25*100, integer=True)
        shunt[43]= sep.Var(qshunt[43]*100,-0.1*100,0*100, integer=True)
        shunt[44]= sep.Var(qshunt[44]*100,-0.1*100,0*100, integer=True)
        shunt[45]= sep.Var(qshunt[45]*100,-0.1*100,0*100, integer=True)
        shunt[47]= sep.Var(qshunt[47]*100,-0.15*100,0*100, integer=True)
        shunt[73]= sep.Var(qshunt[73]*100,-0.2*100,0*100, integer=True)
        shunt[78]= sep.Var(qshunt[78]*100,-0.2*100,0*100, integer=True)
        shunt[81]= sep.Var(qshunt[81]*100,-0.2*100,0*100, integer=True)
        shunt[82]= sep.Var(qshunt[82]*100,-0.2*100,0*100, integer=True)
        shunt[104]= sep.Var(qshunt[104]*100,-0.2*100,0*100, integer=True)
        shunt[106]= sep.Var(qshunt[106]*100,-0.2*100,0*100, integer=True)
        shunt[109]= sep.Var(qshunt[109]*100,-0.2*100,0*100, integer=True)
...
#         shunt[109]= sep.sos1([0,-0.06,-0.07,-0.13,-0.14,-0.2])
        ...
        for valor in tap:
            ...
            if side[i]=='hv' or side[i]=='lv':
                ...
                taps.append(sep.Var(valor*100,90,110,integer=True))
