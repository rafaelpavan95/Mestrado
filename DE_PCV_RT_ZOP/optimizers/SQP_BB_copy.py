...
########################################################################### Vetores de condutância e susceptância série
    ...
    if len(sep_modelo.bus)==118:
        ...
        pg[68] = sep_modelo.res_ext_grid['p_mw'].values/100
    ...
    if len(sep_modelo.bus) == 118:
        ...
        for bus in range(len(sep_modelo.bus)):
            ...
            else: angulos.append(sep.Var(theta[bus],0,2*np.pi))
...
#         shunt[109]= sep.Var(qshunt[109],-0.2,0)
        ...
        shunt[4]= sep.Var(qshunt[4],aux_ls,aux_us,integer=True)
        ...
        shunt[33]= sep.Var(qshunt[33],aux_ls,aux_us,integer=True)
        ...
        shunt[36]= sep.Var(qshunt[36],aux_ls,aux_us,integer=True)
        ...
        shunt[43]= sep.Var(qshunt[43],aux_ls,aux_us,integer=True)
        ...
        shunt[44]= sep.Var(qshunt[44],aux_ls,aux_us,integer=True)
        ...
        shunt[45]= sep.Var(qshunt[45],aux_ls,aux_us,integer=True)
        ...
        shunt[47]= sep.Var(qshunt[47],aux_ls,aux_us,integer=True)
        ...
        shunt[73]= sep.Var(qshunt[73],aux_ls,aux_us,integer=True)
        ...
        shunt[78]= sep.Var(qshunt[78],aux_ls,aux_us,integer=True)
        ...
        shunt[81]= sep.Var(qshunt[81],aux_ls,aux_us,integer=True)
        ...
        shunt[82]= sep.Var(qshunt[82],aux_ls,aux_us,integer=True)
        ...
        shunt[104]= sep.Var(qshunt[104],aux_ls,aux_us,integer=True)
        ...
        shunt[106]= sep.Var(qshunt[106],aux_ls,aux_us,integer=True)
        ...
        shunt[109]= sep.Var(qshunt[109],aux_ls,aux_us,integer=True)
...
#         shunt[109]= sep.sos1([0,-0.06,-0.07,-0.13,-0.14,-0.2])
        ...
        for valor in tap:
            ...
            if side[i]=='hv' or side[i]=='lv':
                ...
                taps.append(sep.Var(valor,aux_l,aux_u,integer=True))
...
#         custo
        ...
        # sep.solver_options =['minlp_maximum_iterations 10000',
...
#                             'bound_frac 1e-4']  
        ...
        print(aux_us, aux_ls)
        shunt[8]= sep.Var(qshunt[8],aux_ls,aux_us)
        ...
        for valor in tap:
            ...
            if i<3:
                ...
                taps.append(sep.Var(valor,aux_l,aux_u))
            else: 
