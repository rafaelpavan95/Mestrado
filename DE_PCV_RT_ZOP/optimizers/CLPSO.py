...
def Comprehensive_Learning_PSO(sep, refresh_gap, p1_, zeta, psi, sigma, omega, neta, max_iter, n_particles,c, v_amp,valor_inicial,step, wmax,wmin,relatorio=True,inicial=True):
    ...
    for i in range(0,max_iter):
        ...
        v_novo = np.multiply(w_novo,v_anterior.copy()) + c*np.multiply(r1,(pbestfi.copy()-enxame_fit.copy())) 
