...
def automatiza_apopt(sep_teste, verbose=True, travado=False):
...
#         shunt[109]= sep.sos1([0,-0.06,-0.07,-0.13,-0.14,-0.2])
        ...
        auxx = 0.03
        side = sep14.trafo['tap_side'].values
        i=0
...
#         custo
        ...
        e_k = (5/100)*((a_k*sep14.gen['max_p_mw'].values**2 + b_k*sep14.gen['max_p_mw'].values + c_k + a_k*sep14.gen['min_p_mw'].values**2 + b_k*sep14.gen['min_p_mw'].values + c_k )/2)
...
#                             'bound_frac 1e-4']  
        ...
        sep14.trafo['tap_pos'][sep14.trafo['tap_step_percent']==np.nan] = 1.000
...
#         custo
        ...
        b_k0=sep14.poly_cost['cp1_eur_per_mw'][sep14.poly_cost['et']=='ext_grid'].values
        c_k0=sep14.poly_cost['cp0_eur'][sep14.poly_cost['et']=='ext_grid'].values
        e_k0 = (5/100)*((a_k0*sep14.ext_grid['max_p_mw'].values**2 + b_k0*sep14.ext_grid['max_p_mw'].values + c_k0 + a_k0*sep14.ext_grid['min_p_mw'].values**2 + b_k0*sep14.ext_grid['min_p_mw'].values + c_k0 )/2)
        f_k0 = (4*np.pi/(sep14.ext_grid['max_p_mw'].values-sep14.ext_grid['min_p_mw'].values))
...
#         print('pgs 1', aa[0],bb[0],cc[0])
#         print('pgs 0', dd[0],ee[0],ff[0])
#         print('pgs 4', gg[0],hh[0])
#         print('pgs 7', ii[0],jj[0])
#         print('pgs 10', kk[0],ll[0])
#         print('pgs 12', mm[0],nn[0])
        ...
        print(alfa[0][0],alfa[1][0],alfa[2][0],alfa[3][0],alfa[4][0],alfa[5][0])
    ...
    return gbest, sep14, tensao, t, s, pgs, qg, sep.options.OBJFCNVAL
